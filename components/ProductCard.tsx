...
return (
  <Link href={`/product/${price}-${name.replace(/\s+/g, "-").toLowerCase()}`} className="block">
    <div className="bg-white rounded-2xl shadow-sm overflow-hidden relative border hover:shadow-md transition">
